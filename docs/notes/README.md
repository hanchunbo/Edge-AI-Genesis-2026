...
| 文件 | 收纳主题 | 来源周 | 状态 |
|---|---|---|---|
| [inference.md](inference.md) | ONNX vs ORT、shape/tensor/Ort::Value、Env/Session/Engine、Env 全局唯一、零拷贝输入、CPU/GPU 内存 + Host→Device、I/O 元数据缓存、EP 优雅回退 | W14/W15 | ✅ 试点（W14 概念已入，W15 softmax/Top-K/图优化待补） |
...
| `image-ops.md` | 双线性插值、Letterbox、HWC2CHW、归一化、坐标对齐模式、cv::Mat::isContinuous | W9/W10/W13/W15 | ⬜ 计划中 |
