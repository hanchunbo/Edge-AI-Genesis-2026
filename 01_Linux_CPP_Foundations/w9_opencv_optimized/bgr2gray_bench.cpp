...
//
// ============================================================================
// 文件功能：BGR→Gray 三版实现 benchmark（main 入口）
//   对比 V1/V2/V3 与 cv::cvtColor 在 1080P 图像上的耗时
// ============================================================================
...
int main() {
  ...
  auto r1 = bench("V1 ptr", w9::BgrToGrayV1);
  auto r2 = bench("V2 span", w9::BgrToGrayV2);
  auto r3 = bench("V3 mdspan", w9::BgrToGrayV3);
